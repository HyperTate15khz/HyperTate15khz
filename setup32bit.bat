...
start /wait Tools\Runtimes\2008\vcredist_x86.exe /q 
Echo Installing C++ 2010 Runtimes ...
start /wait Tools\Runtimes\2010\vcredist_x86.exe /q /repair /norestart
Echo Installing C++ 2012 Runtimes ...
start /wait Tools\Runtimes\2012\vcredist_x86.exe /q /repair /norestart
Echo Installing C++ 2013 Runtimes ...
start /wait Tools\Runtimes\2013\vcredist_x86.exe /q /repair /norestart
